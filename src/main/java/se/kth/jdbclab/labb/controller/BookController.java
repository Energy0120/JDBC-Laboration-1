...
import se.kth.jdbclab.labb.model.Genre;
...
public class BookController {
    ...
    public BookController(MainView view) {
        ...
        try {
            ...
            view.getViewButton().setOnAction(e -> viewBook());
    ...
    private void loadBooks() {
        try {
            String query1 = "SELECT  T_Book.ISBN,  T_Book.Title, T_Author.AuthorName, T_book_genre.genre, T_Grade.gradeID, T_Grade.grade, T_Grade.gradeText, T_Grade.gradeDate\n" +
                    "FROM T_Book\n" +
            ...
            try (Statement stmt = connection.createStatement();
                ...
                while (rs.next()) {
                    ...
                    Review grade = new Review(rs.getInt("T_Grade.gradeID"), rs.getInt("T_Grade.grade"), rs.getString("T_Grade.GradeText"), rs.getDate("T_Grade.GradeDate"));
